...
q,wl,fwhm = np.loadtxt('../../data/cwis/CWIS_Wavelengths_20220331.txt').T * 1000.0
...
for scan in range(1,6):
    ...
    if True:
        ...
        timestamp = '20220428'
        np.savetxt('../../data/cwis/CWIS_RadiometricCoeffs_'+timestamp+'_'+str(scan)+'.txt',
