...
input_files = [basedir+'/radcal/emit20220305t002601_o00000_s000_l1a_raw_b0100_v01_strip_shift_darksub_pedestal_badfix_osffix_linear_scatterfix_ghostfix_flat',
               basedir+'/radcal_half/emit20220305t161821_o00000_s000_l1a_raw_b0100_v01_strip_shift_darksub_pedestal_badfix_osffix_linear_scatterfix_ghostfix_flat',
               basedir+'/radcal_50/emit20220305t022009_o00000_s000_l1a_raw_b0100_v01_strip_shift_darksub_pedestal_badfix_osffix_linear_scatterfix_ghostfix_flat',
...
if False:
    ...
    # Sphere radiance.  Mark provided a total uncertainty of 3.0% via RSS of lamp, spectralon,
    # transfer, and stability uncertainty terms
    wl_sphere, radiance_sphere =  np.loadtxt('../data/ogse/tvac4b/sphere_radiance.txt',skiprows=1).T
    radiance_sphere = radiance_sphere * 1e6 / 1e4 # convert W/m^2/nm/sr to uW/cm^2/nm/sr
    sphere_uncert = radiance_sphere * 0.03


    radiance_sphere = resample(wl_sphere, radiance_sphere)
    sphere_uncert = resample(wl_sphere, sphere_uncert)
    ...
    # Radiance 
    rdn = radiance_sphere *  mirror_rfl * window_trans 
    rdn_uncert = 0.03 * rdn

    basedir = '/beegfs/scratch/drt/20220303_EMIT_TVAC4b/asd_full_infocus/'
    input_file = basedir+'emit20220308t200138_o00000_s000_l1a_raw_b0101_v01_strip_shift_darksub_pedestal_flat'
    ...
    if True:
        ...
        plt.plot(wl,DN)
        plt.plot(wl,rdn*DN.mean()/rdn.mean())
