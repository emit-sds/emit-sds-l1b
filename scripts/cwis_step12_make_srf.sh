...
python ../utils/makesrf.py --piecewise_velocity --wavelengths ../data/CWIS_Wavelengths_20220203.txt --bottom 6800 --top_margin 500 --target_index 1214 $fin  > ${fin}_1214.txt
...
python ../utils/makesrf.py --piecewise_velocity --wavelengths ../data/CWIS_Wavelengths_20220203.txt --bottom 21500 --top_margin 500 --target_index 1214 $fin  > ${fin}_1214.txt
